        ...
        <div className="poster-box">
          <div className="profile">
            ...
            <div className="block profile-photos">
              ...
              >
                <div
                  ...
                  key={detailData.id}
                  ref={current => (galleryBox = current)}
                >
                    ...
                    return (
                      <div className="gallery-img" key={index}>
                        {index === 0 && detailData.trailer_urls.length > 0 && (
                          <>
                            <Tag color="#f50" className="img-tag">
                              预告片
                            </Tag>
                            <Icon
                              type="play-circle"
                              ...
                              onClick={ev => {
                                openPlayBox(
                                  detailData.trailer_urls[
                                    currentPlayData.index
                                  ],
                                  detailData.title
                                );
                              }}
            ...
            <div
              className={[
                "drawer-in",
                isOpenPlayBox ? "drawer-fixed-bottom" : ""
              ].join(" ")}
            >
              <div className="block profile-reviews">
                ...
                {detailData.popular_reviews.map((item: any, index: number) => {
                  let { author, rating, title, summary, created_at } = item;
      ...
      >
        <div className="container-video clearfix">
          <div className="video-box">
            <video
              src={currentPlayData.src}
              autoPlay={currentPlayData.isAutoPlay}
              controls
            />
              ...
              <List
                ...
                renderItem={(item: any, index: number) => (
                  <List.Item
                    className={[
                      "list-item",
                      index === currentPlayData.index ? "active" : ""
                    ].join(" ")}
                    key={item.id}
